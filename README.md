...
Make sure all the [required](https://github.com/bnl987/PhoneSploit-Pro#requirements) software are installed.

Open terminal and paste the following commands : 
```
git clone https://github.com/bnl987/PhoneSploit-Pro.git
```
```
cd PhoneSploit-Pro/
```
...
**Ethical.Kuldeep** - [@bnl987](https://github.com/bnl987/)
